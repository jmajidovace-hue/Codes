...
def analyze_dividend_recovery_chart(ticker_input):
    ...
    for date, amount in recent_dividends.items():
        ...
        # FULL COLUMN SET AS PER ORIGINAL COLAB
    ...
    stats_dict = {
        ...
        'target_rally_date': str(target_entry_date_20d.date()) if target_entry_date_20d else None,
        'target_sweet_date': str(target_entry_date_sweet.date()) if target_entry_date_sweet else None,
        'target_div_date': str(target_entry_date_5d.date()) if target_entry_date_5d else None,
